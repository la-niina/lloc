            ...
            <Layout>
                <Navbar isCompact isBordered={isDark} variant="sticky">
                    ...
                    >
                        ...
                        <Navbar.Link isActive href="/community">community</Navbar.Link>
                    ...
                    >
                        ...
                        <Modal.Footer>
                            ...
                            <Button auto rounded color="gradient" onClick={closeHandler}>
                                Sign in
                            </Button>
                        </Modal.Footer>
                    </Modal>
                    ...
                    <Navbar.Collapse>
                        ...
                        <Navbar.CollapseItem>
                            <Link weight="bold" css={{ textGradient: "45deg, $yellow600 -20%, $red600 100%" }} href="/community">community</Link>
                        </Navbar.CollapseItem>
